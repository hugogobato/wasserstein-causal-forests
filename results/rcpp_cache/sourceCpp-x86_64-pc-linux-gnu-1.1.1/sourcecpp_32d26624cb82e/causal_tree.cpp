...
// causal_drf_grow_tree
List causal_drf_grow_tree(NumericMatrix X, IntegerVector W, NumericMatrix Phi, IntegerVector build_rows, IntegerVector pop_rows, int mtry, int min_arm_build, int min_arm_pop, double alpha, int max_depth);
RcppExport SEXP sourceCpp_1_causal_drf_grow_tree(SEXP XSEXP, SEXP WSEXP, SEXP PhiSEXP, SEXP build_rowsSEXP, SEXP pop_rowsSEXP, SEXP mtrySEXP, SEXP min_arm_buildSEXP, SEXP min_arm_popSEXP, SEXP alphaSEXP, SEXP max_depthSEXP) {
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< IntegerVector >::type build_rows(build_rowsSEXP);
    Rcpp::traits::input_parameter< IntegerVector >::type pop_rows(pop_rowsSEXP);
    Rcpp::traits::input_parameter< int >::type mtry(mtrySEXP);
    Rcpp::traits::input_parameter< int >::type min_arm_build(min_arm_buildSEXP);
    Rcpp::traits::input_parameter< int >::type min_arm_pop(min_arm_popSEXP);
    Rcpp::traits::input_parameter< double >::type alpha(alphaSEXP);
    Rcpp::traits::input_parameter< int >::type max_depth(max_depthSEXP);
    rcpp_result_gen = Rcpp::wrap(causal_drf_grow_tree(X, W, Phi, build_rows, pop_rows, mtry, min_arm_build, min_arm_pop, alpha, max_depth));
    return rcpp_result_gen;
END_RCPP
}
// causal_drf_predict_weights
List causal_drf_predict_weights(List trees, IntegerVector tree_group, int n_groups, NumericMatrix X_test, IntegerVector W, int n_train, bool with_groups);
RcppExport SEXP sourceCpp_1_causal_drf_predict_weights(SEXP treesSEXP, SEXP tree_groupSEXP, SEXP n_groupsSEXP, SEXP X_testSEXP, SEXP WSEXP, SEXP n_trainSEXP, SEXP with_groupsSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< List >::type trees(treesSEXP);
    Rcpp::traits::input_parameter< IntegerVector >::type tree_group(tree_groupSEXP);
    ...
    rcpp_result_gen = Rcpp::wrap(causal_drf_predict_weights(trees, tree_group, n_groups, X_test, W, n_train, with_groups));
    return rcpp_result_gen;
END_RCPP
}
