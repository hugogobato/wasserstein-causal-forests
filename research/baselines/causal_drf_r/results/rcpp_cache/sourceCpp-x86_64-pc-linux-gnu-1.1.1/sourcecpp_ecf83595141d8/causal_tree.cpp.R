`.sourceCpp_1_DLLInfo` <- dyn.load('/home/hugo_souto/Stuff/Research/Wasserstein_Causal_Forests/research/baselines/causal_drf_r/results/rcpp_cache/sourceCpp-x86_64-pc-linux-gnu-1.1.1/sourcecpp_ecf83595141d8/sourceCpp_2.so')
