...
16 self-contained notebooks covering 160 cells of the frozen sensitivity study exactly once, over the requested methods: `cwdb_dr`, `cwdb_dr_flex`, `cwdb_dr_oracle`. The rough reference total is 26.5 hours.
...
|---|---|---|---|---|
| `wcf_sensitivity_shard_00.ipynb` | 10 | 99 | 1.65 | cwdb_dr |
| `wcf_sensitivity_shard_01.ipynb` | 10 | 99 | 1.65 | cwdb_dr |
| `wcf_sensitivity_shard_02.ipynb` | 10 | 99 | 1.65 | cwdb_dr |
| `wcf_sensitivity_shard_03.ipynb` | 10 | 99 | 1.65 | cwdb_dr |
| `wcf_sensitivity_shard_04.ipynb` | 10 | 99 | 1.65 | cwdb_dr |
| `wcf_sensitivity_shard_05.ipynb` | 10 | 99 | 1.65 | cwdb_dr |
| `wcf_sensitivity_shard_06.ipynb` | 10 | 99 | 1.65 | cwdb_dr |
| `wcf_sensitivity_shard_07.ipynb` | 10 | 99 | 1.65 | cwdb_dr |
| `wcf_sensitivity_shard_08.ipynb` | 10 | 99 | 1.65 | cwdb_dr |
| `wcf_sensitivity_shard_09.ipynb` | 10 | 99 | 1.65 | cwdb_dr |
| `wcf_sensitivity_shard_10.ipynb` | 10 | 99 | 1.65 | cwdb_dr |
| `wcf_sensitivity_shard_11.ipynb` | 10 | 99 | 1.65 | cwdb_dr |
| `wcf_sensitivity_shard_12.ipynb` | 10 | 99 | 1.65 | cwdb_dr |
| `wcf_sensitivity_shard_13.ipynb` | 10 | 99 | 1.65 | cwdb_dr |
| `wcf_sensitivity_shard_14.ipynb` | 10 | 99 | 1.65 | cwdb_dr |
| `wcf_sensitivity_shard_15.ipynb` | 10 | 99 | 1.65 | cwdb_dr |
